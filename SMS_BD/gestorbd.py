...
class GestorAlumno:
    ...
    def nuevoAlumno(self, dni, nombre):
        ...
        db = MySQLdb.connect(host="localhost", user=str(us), passwd=str(pa), db="mdb")
...
'''
    ...
    def borrarAlumno(self, dnient):
        db = MySQLdb.connect(host="localhost", user=str(us), passwd=str(pa), db="mdb"); #La conexión está clara.
