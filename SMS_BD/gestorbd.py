...
class GestorAlumno:
    ...
    def nuevoAlumno(self, dni, nombre):
        ...
        db = MySQLdb.connect(host="localhost", user=os.environ["USER"], passwd=os.environ["PASS"], db="mdb")
...
'''
    ...
    def borrarAlumno(self, dnient):
        db = MySQLdb.connect(host="localhost", user=os.environ["USER"], passwd=os.environ["PASS"], db="mdb"); #La conexión está clara.
